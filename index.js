...
// //! ANSWER: O(1), No, trust me we tried for like 15 minutes
// function printFirstTwoNames(array) {
...
function squareEveryDigit(num) {
    ...
    for(let i = 0; i < numString.length; i++) {
      let squaredNum = +numString[i] * +numString[i]
      answers.push(squaredNum)
    }
    
    console.log(+answers.join(''))
}
// ! Time Complexity would be about 2 years... JK, O(n)
